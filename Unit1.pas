...
begin
  ...
  ShowMessage('Библиотека MainDll.dll загружена, можете использовать'
    +#10#13+'нужные вам библиотечные функции');
  MessageBeep(1000);

  RichEdit1.Lines.Add('Сумма X и Y равна '+ FloatToStr(SummaX_Y(X,Y)));
  RichEdit1.Lines.Add('');

  RichEdit1.Lines.Add('Произведение X и Y равно '+ FloatToStr(ProizvX_Y(X,Y)));
  RichEdit1.Lines.Add('');
